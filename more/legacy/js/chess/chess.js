    ...
    document.querySelectorAll('.box').forEach(image => {
        ...
        if (image.innerText.length !== 0) {
            if (image.innerText == 'Wpawn' || image.innerText == 'Bpawn') {
                image.innerHTML = `${image.innerText} <img class='allimg allpawn' src="img/chess/${image.innerText}.png" alt="">`
                ...
                image.innerHTML = `${image.innerText} <img class='allimg' src="img/chess/${image.innerText}.png" alt="">`
                image.style.cursor = 'pointer'
            }
        }
    })
...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('touchstart', function () {
        ...
        if (tog % 2 !== 0) {
            document.getElementById('tog').innerText = "Weiß ist dran"
            whosTurn('W')
        }
        if (tog % 2 == 0) {
            document.getElementById('tog').innerText = "Schwarz ist dran"
            whosTurn('B')
        }
        ...
        if (numOfKings == 1) {
            setTimeout(() => {
                if (tog % 2 == 0) {
                    announcer.innerHTML = 'Weiß hat gewonnen!';
                }
                else if (tog % 2 !== 0) {
                    announcer.innerHTML = 'Schwarz hat gewonnen!';
                }
            }, 100)
        }
...
// Damit die Figuren bewegt können
document.querySelectorAll('.box').forEach(hathiTest => {
    ...
    hathiTest.addEventListener('touchstart', function () {
        ...
        if (hathiTest.style.backgroundColor == 'pink') {
            ...
            document.querySelectorAll('.box').forEach(hathiTest2 => {
                ...
                hathiTest2.addEventListener('touchstart', function () {
                    if (hathiTest2.style.backgroundColor == 'green' && hathiTest2.innerText.length == 0) {
                        document.getElementById(pinkId).innerText = ''
                        hathiTest2.innerText = pinkText
                        coloring()
...
// Damit nicht mehrere Elemente benutzt werden können
z = 0
document.querySelectorAll('.box').forEach(ee => {
    ...
    ee.addEventListener('touchstart', function () {
        z = z + 1
        if (z % 2 == 0 && ee.style.backgroundColor !== 'green') {
            coloring()
        }
